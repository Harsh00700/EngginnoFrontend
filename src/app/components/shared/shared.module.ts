...
import { PreloaderComponent } from 'src/app/components/shared/preloader/preloader.component';
...
@NgModule({
  ...
  exports: [BlogsidebarComponent, BreadcrumbsComponent, CanvasComponent, CategoryComponent, DealsliderComponent, FooterComponent, HeaderComponent, HeadertwoComponent, HeaderthreeComponent, InstagramComponent, MobilemenuComponent, NavigationComponent, RelatedpostComponent, RelatedproductComponent, ShopsidebarComponent, PreloaderComponent]
})
